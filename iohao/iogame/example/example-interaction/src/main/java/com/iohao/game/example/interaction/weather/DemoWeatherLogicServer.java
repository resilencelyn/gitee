 ...
 * @date 2022-03-24
 */
public record DemoWeatherLogicServer(int gatewayPort) implements ClientStartup {
    ...
    public ModuleMessage createModuleMessage() {
        ...
        int moduleId = DemoLogicServerModuleId.moduleIdDemoWeatherLogicServer;
        var moduleKey = ModuleKeyKit.getModuleKey(moduleId);

        // 子模块 逻辑服的信息描述
        return new ModuleMessage(moduleKey)
                .setName("demo 天气预报 逻辑服 ")
                .setDescription("demo 天气预报 业务");
    }
