 ...
 * @date 2022-03-24
 */
public record DemoFightLogicServer(int gatewayPort) implements ClientStartup {
    ...
    public ModuleMessage createModuleMessage() {
        ...
        int moduleId = DemoLogicServerModuleId.moduleIdDemoFightLogicServer;
        var moduleKey = ModuleKeyKit.getModuleKey(moduleId);

        // 子模块 逻辑服的信息描述
        return new ModuleMessage(moduleKey)
                .setName("demo 战斗 逻辑服 ")
                .setDescription("demo 战斗 业务");
    }
