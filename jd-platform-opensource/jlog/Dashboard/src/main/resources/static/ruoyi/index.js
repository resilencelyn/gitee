...
$(function() {
    ...
    function menuItem() {
        ...
        if (flag) {
            ...
            // 添加选项卡对应的iframe
            var str1 = '<iframe class="RuoYi_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + params + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
    ...
    window.goMenuItem= function(id, params) {
        $.modal.closeTab(id);
        $("[href= '" + id + "']").attr("params", params);
        $("[href= '" + id + "']").click();
    }
});