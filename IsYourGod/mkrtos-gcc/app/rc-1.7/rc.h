...
#define lookup_fn(s) ((rc_Function *) rc_lookup(s, fp))
#define lookup_var(s) ((Variable *) rc_lookup(s, vp))
...
/* hash.c */
extern Htab *fp, *vp;
extern void *rc_lookup(char *, Htab *);
...
/* match.c */
extern bool rc_match(char *, char *, char *);
