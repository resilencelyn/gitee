...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"WICA", pos = wx.DefaultPosition, size = wx.Size( 545,434 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		sbSizer3.Add( self.m_spinCtrl1, 1, wx.ALL|wx.EXPAND, 5 )
		...
		sbSizer10.Add( self.m_toggleBtn1, 1, wx.ALL|wx.EXPAND, 5 )
		...
		sbSizer11.Add( self.m_toggleBtn2, 1, wx.ALL|wx.EXPAND, 5 )
		...
		self.m_menu2.Append( self.m_menuItem91 )
