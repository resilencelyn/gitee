...
# tag3 -> add the function of sending files;
# tag4 -> .......
# tag5 -> .......
# tag6 -> .......
# .............
...
sys.path.append(BASE_DIR + "\\test_phone")  # add an environment.
...
class CalcFrame1(MyFrame1):
    ...
    def __init__(self, parent):
        ...
        MyFrame1.__init__(self, parent)  # set the variables.
    ...
    def m01to_connectthe_cap(self, event):
        ...
        if res1 == 0 and res2[-8:-2] == "device":  
            # the network is fine.
            time.sleep(1.25)  # to make the connection seems real.
    ...
    def m04startcontrol(self, event):
        ...
        cv2.namedWindow("image")  # name the window -> image.
        ...
        cv2.destroyAllWindows()  # must destroy.
    ...
    def m26sending_texts(self, event):
        ...
        try:
            ...
            try:
                ...
                self.m_textCtrl2.SetValue("")  # clear.
                pass
...
if __name__ == "__main__":  # main method.
    ...
    frame.Show(True)
    app.MainLoop()  # mainloop -> execute the apps.
