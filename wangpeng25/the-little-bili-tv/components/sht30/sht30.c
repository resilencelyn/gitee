...
*/
//I2C 
#define I2C_SCL_IO          22                  //SCL->IO33
#define I2C_SDA_IO          21                  //SDA->IO32
...
#define CMD_FETCH_DATA_H    0x20                //循环采样，参考sht30 datasheet
#define CMD_FETCH_DATA_L    0x2f
...
void i2c_init(void)
{
    ...
    .master.clk_speed = 100000,                 //I2C CLK频率
...
int sht30_get_value()
{
    ...
    if( (!SHT3X_CheckCrc(sht30_buf,2,sht30_buf[2])) && (!SHT3X_CheckCrc(sht30_buf+3,2,sht30_buf[5])) )
    {
        ...
        sht.temp =(uint8_t) ( ((float)date *175)/65535 -50  );
        sht.humi =(uint8_t)( ( (sht30_buf[3]*256) + (sht30_buf[4]) )*100/65535.0) ;
    }
    else
    {
        ret = 1;
