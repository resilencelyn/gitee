...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.yunze.common.annotation.DataScope)")
        ...
        if (StringUtils.isNotNull(loginUser))
        {
            ...
            if (StringUtils.isNotNull(currentUser) && !currentUser.isAdmin())
            {
                dataScopeFilter(joinPoint, currentUser, controllerDataScope.deptAlias(),
                        controllerDataScope.userAlias(),controllerDataScope.isMap());
            }
        }
    }
     ...
     * @param userAlias 别名
     */
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias,boolean  isMap)
    {
        ...
        if (StringUtils.isNotBlank(sqlString.toString()))
        {
           ...
           if(isMap==true){
               ...
               {
                   Map<String,Object> baseMap = (Map<String,Object>) params;
                   baseMap.put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
               }
           }else{
