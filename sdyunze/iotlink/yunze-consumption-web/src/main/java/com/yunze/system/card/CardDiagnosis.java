...
public class CardDiagnosis {
     ...
     */
    @RabbitHandler
    @RabbitListener(queues = "admin_CardDiagnosis_queue")
    ...
    @RabbitHandler
    @RabbitListener(queues = "admin_CardDiagnosis_queue")
    public void CardDiagnosis_3(String msg, Channel channel) throws IOException {
        Main(msg);
    }
    ...
    public void Main(String msg)  {
        try {
            ...
            String prefix = "admin_CardDiagnosis_queue";
            ...
            log.error(">>错误 - 连接诊断 消费者:{}<<", e.getMessage());
        }
    }
