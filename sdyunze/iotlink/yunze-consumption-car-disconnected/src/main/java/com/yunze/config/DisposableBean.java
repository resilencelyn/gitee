...
public class DisposableBean {
    ...
    public void exit(){
        ...
        System.out.println("cardDisconnected 程序结束 执行删除redis Listener 记录key ");
        ...
        if(IDArr!=null && IDArr.size()>0) {
            ...
            for (int i = 0; i < IDArr.size(); i++) {
                ...
                redisCache.redisTemplate.delete("polling_cardCardDisconnected_queue_"+cd_id);
                redisCache.redisTemplate.delete("polling_dlxcardCardDisconnected_queue"+cd_id);
            }
        }
