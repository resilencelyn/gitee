  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px" style="margin-bottom:-10px;line-height:35px">
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-form-item label="参数名称" prop="configName" style="margin-bottom:10px;line-height:35px">
            <el-input
        ...
        <el-col :span="1.5">
          <el-form-item label="参数键名" prop="configKey" style="margin-bottom:10px;line-height:35px">
            <el-input
