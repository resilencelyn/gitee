    ...
    <el-row :gutter="20">
      ...
      <el-col :span="mainwidth" :xs="24" >
        ...
        <el-row :gutter="10" class="mb8">
          <right-toolbar :showSearch.sync="showSearch"   v-hasPermi="['yunze:executionTask:list']" @queryTable="getList" :columns="columns"></right-toolbar>
        </el-row>
        ...
        <el-table v-loading="loading" :data="cardList" @selection-change="handleSelectionChange">
          ...
          <el-table-column   label="开始时间" align="center"  prop="start_time" v-if="columns[3].visible" />
          <el-table-column   label="结束时间" align="center"  prop="end_time" v-if="columns[4].visible" />
          <el-table-column   label="创建人" align="center"  prop="auth" v-if="columns[5].visible" />
    ...
    <el-dialog :close-on-click-modal="false"
      ...
      <el-row :gutter="20">
        <ul class="list-group" v-for="(item,index) in Urls">
          <li >
            <span @click="getDownloadExecutionTask(item)" class="link-type"v-hasPermi="['yunze:executionTask:download']">{{ item.name }} CSV</span>

            <span style="margin-left: 20px;" @click="getdownloadConversionk(item)" class="link-type"v-hasPermi="['yunze:executionTask:download']">{{ item.name }} XLS</span>
          </li>
        </ul>
      </el-row>
    </el-dialog>
