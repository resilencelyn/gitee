package com.yunze.quartz.task.yunze.cvalue;
...
public class CEndValue {
     ...
     * */
    public void cendalue(Integer Time) {
        //1.创建路由 绑定 生产队列 发送消息
        //导卡 路由队列
        String polling_queueName = "admin_CEndValue_queue";
        String polling_routingKey = "admin.CEndValue.queue";
        ...
        try {
            ...
            start_type.put("Masage", "备份 执行 admin_CEndValue_queue ");//启动类型
