$.fn.extend({
    l_zoom: function(c) {
        ...
        var b = $('<div class="zoom_right"></div><div class="zoom_rb"></div><div class="zoom_bottom"></div> <img class="switted-c delet-c" src="/static/fk/delete.png" alt=""><img class="switted-c copy-c" src="/static/fk/copy.png" alt="">');
        this.append(b);
        $(".zoom_right").mousedown(function(h) {
            ...
            var height = parseInt(g.parent().css("height"));
            var d = {
                x: h.clientX,
                y: h.clientY
            };
            window.onmousemove = function(i) {
                ...
                set_ui(g,f + i.clientX - d.x,height);
            };
        ...
        $(".zoom_bottom").mousedown(function(h) {
            ...
            var width = parseInt(f.parent().css("width"));
            var d = {
                x: h.clientX,
                y: h.clientY
            };
            window.onmousemove = function(i) {
                ...
                set_ui(f,width,g + i.clientY - d.y);
            };
        ...
        $(".zoom_rb").mousedown(function(i) {
            ...
            window.onmousemove = function(l) {
                ...
                set_ui(g,f + l.clientX - d.x,h + l.clientY - d.y);
            };
