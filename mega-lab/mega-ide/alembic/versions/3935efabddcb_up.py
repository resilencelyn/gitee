...
Revision ID: 3935efabddcb
Revises: 
Create Date: 2022-02-21 16:24:57.952259
...
def upgrade():
    ...
    sa.Column('enable', sa.Integer(), nullable=False, comment='是否启用镜像源(0:禁用,1:启用)'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
