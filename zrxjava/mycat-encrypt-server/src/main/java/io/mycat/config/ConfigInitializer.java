...
import io.mycat.config.loader.xml.XMLEncryptLoader;
...
public class ConfigInitializer {
	...
	public ConfigInitializer(boolean loadDataHost) {
		...
		//zrx 读取encrypt.xml
		XMLEncryptLoader encryptLoader = new XMLEncryptLoader();
		...
		//zrx 设置加密
		this.encryptConfigMap = encryptLoader.getEncryptConfigMap();
