...
public final class SystemConfig {
	 ...
	 * 是否使用内置加密算法
	 */
	private int useInternalEncryptAlgorithm;
	...
	public int getUseInternalEncryptAlgorithm() {
		return useInternalEncryptAlgorithm;
	}

	public void setUseInternalEncryptAlgorithm(int useInternalEncryptAlgorithm) {
		this.useInternalEncryptAlgorithm = useInternalEncryptAlgorithm;
	}
