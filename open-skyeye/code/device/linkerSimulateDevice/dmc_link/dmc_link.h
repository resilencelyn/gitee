...
#ifndef __DMC_LINK_H__
#define __DMC_LINK_H__
...
typedef struct dmc_device_list
{
    dmc_device_t device[MAX_DEVICE_NUM];
    int device_num;
}dmc_device_list_t;

typedef struct dmc_link_device
{
    conf_object_t* obj;
    dmc_device_list_t device_list;
}dmc_link_device_t;
