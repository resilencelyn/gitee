...
#ifndef __uart_s3c2410x_H__
#define __uart_s3c2410x_H__
#include "s3c2410x_fifo.h"

typedef struct uart_s3c2410x_reg{
...
typedef struct uart_s3c2410x_device{
	conf_object_t* obj;
	uart_s3c2410x_reg_t* regs;
