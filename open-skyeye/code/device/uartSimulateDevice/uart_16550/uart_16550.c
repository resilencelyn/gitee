...
static attr_value_t get_attr_enter_flag(void* arg, conf_object_t* conf_obj, attr_value_t* idx){
	uart_16550_t *dev =  conf_obj->obj;
	attr_value_t enter_flag_attr = SKY_make_attr_uinteger(dev->enter_flag);
	return enter_flag_attr;
}

static exception_t set_attr_enter_flag(void* arg, conf_object_t* conf_obj, attr_value_t* value, attr_value_t* idx){
	uart_16550_t *dev =  conf_obj->obj;
	dev->enter_flag = SKY_attr_uinteger(*value);
	return No_exp;
}
...
static void uart_16550_register_attribute(conf_class_t* clss){
	...
	SKY_register_attribute(clss, "enter_flag", get_attr_enter_flag, NULL, set_attr_enter_flag, NULL, SKY_Attr_Optional, "uinteger", "Enter Flag for \r or \n");
	return;
}
...
void init_16550_uart(void) {
	static skyeye_class_t class_data = {
		.class_name = "16550_uart",
		.class_desc = "16550_uart",
