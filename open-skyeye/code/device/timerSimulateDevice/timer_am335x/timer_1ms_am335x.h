...
#ifndef __timer_1ms_am335x_H__
#define __timer_1ms_am335x_H__

typedef struct timer_1ms_am335x_reg{
	uint32_t tidr;
	uint32_t tiocp_cfg;
	uint32_t tistat;
	uint32_t tisr;
	...
	uint32_t tocr;
	uint32_t towr;
}timer_1ms_am335x_reg_t;

typedef struct timer_1ms_am335x_device{
	conf_object_t* obj;
	timer_1ms_am335x_reg_t* regs;
	general_signal_intf *signal_obj;
	general_signal_intf *signal;
	uint32_t interrupt_number;
}timer_1ms_am335x_device;
