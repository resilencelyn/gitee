...
#ifndef __mcbsp_c5510_H__
#define __mcbsp_c5510_H__
/* *
 * Mcbsp 0 Address : 0x2800 
 * Mcbsp 1 Address : 0x2c00 
 * Mcbsp 2 Address : 0x3000 
 * */
...
typedef struct mcbsp_c5510_reg{
	...
	uint16_t RCR20;		/* Receiver Control register 2 */
	uint16_t RCR10;		/* Receiver Control register 1 */
	...
	uint16_t PCR0;		/* Pin Control register */
...
typedef struct mcbsp_c5510{
	conf_object_t* obj;
	mcbsp_c5510_reg_t* regs;
