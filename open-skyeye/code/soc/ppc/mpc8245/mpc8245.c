...
static conf_object_t* new_mpc8245(char *obj_name)
{
	mpc8245_device* dev = skyeye_mm_zero(sizeof(mpc8245_device));
...
static exception_t free_mpc8245(conf_object_t* opaque)
{
...
void init_mpc8245(void)
{
	static skyeye_class_t class_data =
	{
		.class_name = "mpc8245",
		.class_desc = "mpc8245",
		.new_instance = new_mpc8245,
		.free_instance = free_mpc8245
	};
