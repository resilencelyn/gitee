...
static conf_object_t* new_mpc8378(char *obj_name)
{
	mpc8378_device* dev = skyeye_mm_zero(sizeof(mpc8378_device));
...
static exception_t free_mpc8378(conf_object_t* opaque)
{
...
void init_mpc8378(void)
{
	static skyeye_class_t class_data =
	{
		.class_name = "mpc8378",
		.class_desc = "mpc8378",
		.new_instance = new_mpc8378,
		.free_instance = free_mpc8378
	};
