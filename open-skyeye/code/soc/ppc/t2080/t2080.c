...
static conf_object_t* new_t2080(char *obj_name)
{
	t2080_device* dev = skyeye_mm_zero(sizeof(t2080_device));
...
static exception_t free_t2080(conf_object_t* opaque)
{
...
void init_t2080(void)
{
	static skyeye_class_t class_data =
	{
		.class_name = "t2080",
		.class_desc = "t2080",
		.new_instance = new_t2080,
		.free_instance = free_t2080
	};
