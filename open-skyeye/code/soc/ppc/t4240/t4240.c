...
static conf_object_t* new_t4240(char *obj_name)
{
	t4240_device* dev = skyeye_mm_zero(sizeof(t4240_device));
...
static exception_t free_t4240(conf_object_t* opaque)
{
...
void init_t4240(void)
{
	static skyeye_class_t class_data =
	{
		.class_name = "t4240",
		.class_desc = "t4240",
		.new_instance = new_t4240,
		.free_instance = free_t4240
	};
