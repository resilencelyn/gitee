...
#include "../../../arch/ppc/common/ppc_mmu.h"
...
static void set_bootcmd(conf_object_t *obj)
{
    ...
    bd_t t;
    memset(&t, '\0', sizeof(t));
    t.bi_immr_base = bswap_word(0xe0000000);
    t.bi_busfreq = bswap_word(100 * 1024 * 1024);
    t.bi_intfreq = bswap_word(500 * 1024 * 1024);
    t.bi_baudrate = bswap_word(9600);
    t.bi_memsize = bswap_word(64 * 1024 * 1024);
    load_data(core,&t, sizeof(t), bd_start);
...
static void setup_boot_map(conf_object_t *obj){
    e500_core_t * core = (e500_core_t *)obj->obj;
    ...
    entry->epn = 0x0000; /* Virtual address of DDR ram in address space*/
...
void mpc8560_boot_linux(conf_object_t *obj)
{
