 ...
 */
/***************************************************************************/
typedef dog_status_t (DOG_CALLCONV *Dog_Login_t)(dog_feature_t feature_id,dog_vendor_code_t vendor_code,dog_handle_t *handle);

typedef dog_status_t (DOG_CALLCONV *Dog_Logout_t)(dog_handle_t handle);

typedef dog_status_t (DOG_CALLCONV *Dog_Read_t) (dog_handle_t handle,dog_fileid_t fileid,dog_size_t offset,dog_size_t length,void * buffer);

typedef dog_status_t (DOG_CALLCONV *Dog_Get_Size_t)(dog_handle_t handle,dog_fileid_t fileid,dog_size_t * size);
