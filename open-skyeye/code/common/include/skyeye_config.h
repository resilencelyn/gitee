...
#define MAX_MACH_NAME_LEN 64
#define MAX_SERIAL_COUNT  64
...
//      ioaddr_config_t ioaddr; //used for ARMul_notIOaddr funciton
	...
	uart_config_t uart;
	log_config_t log;
	char config_mach[MAX_MACH_NAME_LEN];
	uint32_t start_address;
	uint32_t cpu_rate;
	cpu_config_t *p_arm_cpu;
	mach_conf_t machs;
	int running_mode;

	serial_t serial_parameter[MAX_SERIAL_COUNT];
	int serial_count;
