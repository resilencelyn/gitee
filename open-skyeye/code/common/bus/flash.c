...
* @return  data
*/
static uint32 flash_read_byte(uint32 addr)
{
...
* @return data
*/
static uint32 flash_read_halfword(uint32 addr)
{
    struct device_desc *dev;
    uint32 data;
    skyeye_config_t *config = get_current_config();
...
* @return data 
*/
static uint32 flash_read_word(uint32 addr)
{
    struct device_desc *dev;
    uint32 data;
    skyeye_config_t *config = get_current_config();
...
*/
static void flash_write_byte(uint32 addr, uint32 data)
{
    struct device_desc *dev;
    skyeye_config_t *config = get_current_config();
    int i;
...
* @param data the written data
*/
void flash_write_halfword(uint32 addr, uint32 data)
{
    struct device_desc *dev;
    skyeye_config_t *config = get_current_config();
    int i;
...
* @param data the data
*/
static void flash_write_word(uint32 addr, uint32 data)
{
    struct device_desc *dev;
    skyeye_config_t *config = get_current_config();
    int i;
