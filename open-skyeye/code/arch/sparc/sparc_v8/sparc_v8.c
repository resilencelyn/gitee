...
{
    sparc_state_t *dev = (sparc_state_t *)obj->obj;
...
void init_sparc_v8()
{
    ...
    static const sparc_reg_window_intf reg_window = {
        .get_reg_window = sparc_get_reg_window,
    };
    SKY_register_iface(clss, SPARC_REG_WINDOW_INTF_NAME, &reg_window);
    ...
    static const struct InterfaceDescription ifaces[] = {
        ...
        (struct InterfaceDescription) {
            .name = SPARC_REG_WINDOW_INTF_NAME,
            .iface = &reg_window,
        }
    };
