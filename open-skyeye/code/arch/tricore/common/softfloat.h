/*************************************************************************
	> File Name    : softfloat.h
	> Author       : jiachao
	> Mail         : jiachao@digiproto.com
	> Created Time : 2021/10/26 10:19:12
************************************************************************/
...
float16 float32_to_float16(float32, bool_t ieee, float_status *status);
float32 float16_to_float32(float16, bool_t ieee, float_status *status);
float16 float64_to_float16(float64 a, bool_t ieee, float_status *status);
float64 float16_to_float64(float16 a, bool_t ieee, float_status *status);
...
*----------------------------------------------------------------------------*/
static inline bool_t floatx80_invalid_encoding(floatx80 a)
{
