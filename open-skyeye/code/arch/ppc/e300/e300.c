...
#if 0
static void e300_switch_mode(conf_object_t * conf_obj, core_running_mode_t mode)
{
 ...
 */
static uint32 e300_get_ccsr_base(uint32 reg)
{
    return reg;
}
static void e300_dec_io_do_cycle(e500_core_t * core)
{
    core->tbl++;
...
static conf_object_t *new_e300_core(char *obj_name)
{
    ...
    core->dec_io_do_cycle = e300_dec_io_do_cycle;
    core->get_ccsr_base = e300_get_ccsr_base;
...
void free_e300(conf_object_t * obj)
{
...
exception_t reset_e300(conf_object_t * obj, const char *parameter)
{
    e500_core_t *core = (e500_core_t *) (obj->obj);

    return No_exp;
}
static void e300_reset(conf_object_t * conf_obj)
{
    return;
}

static exception_t e300_update_memiface_cache(conf_object_t * conf_obj)
{
    return No_exp;
}
...
void init_e300()
{
    static skyeye_class_t class_data = {
        .class_name = "e300_core",
        .class_desc = "powerpc e300 core",
        .new_instance = new_e300_core,
        .free_instance = free_e300,
        .reset_instance = reset_e300,
    ...
    static const core_update_memiface_cache core_update_memiface_cache = {
        .update_memiface_cache = e300_update_memiface_cache,
    };
