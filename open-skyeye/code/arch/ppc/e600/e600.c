...
static conf_object_t *new_e600_core(char *obj_name)
{
...
void free_e600(conf_object_t * obj)
{
...
exception_t reset_e600(conf_object_t * obj, const char *parameter)
{
    e500_core_t *core = (e500_core_t *) (obj->obj);
...
static void e600_reset(conf_object_t * conf_obj)
{
    return;
}

static exception_t e600_update_memiface_cache(conf_object_t * conf_obj)
{
    return No_exp;
}
...
void init_e600()
{
    static skyeye_class_t class_data = {
        .class_name = "e600_core",
        .class_desc = "powerpc e600 core",
        .new_instance = new_e600_core,
        .free_instance = free_e600,
        .config_instance = config_ppc_core,
        .reset_instance = reset_e600,
        .get_attr = NULL,
        .set_attr = NULL
    };
    ...
    static const core_update_memiface_cache core_update_memiface_cache = {
        .update_memiface_cache = e600_update_memiface_cache,
    };
