 ...
 * ----------------------------------------
 */
static void MPC8xx_BootMap(MPC8xx_MemCo * memco)
{
    uint32_t start, end;
    uint32_t mapsize;
 ...
 * ----------------------------------------------
 */
static void MPC8xx_RebuildMmap(MPC8xx_MemCo * memco)
{
    BusDevice *bdev;
    int i;
...
static uint32_t br_read(void *clientData, uint32_t address, int rqlen)
{
...
static void br_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    MPC8xx_MemCo *memco = (MPC8xx_MemCo *) clientData;
    int offs = (address >> 3) & 7;
...
static uint32_t or_read(void *clientData, uint32_t address, int rqlen)
{
    MPC8xx_MemCo *memco = (MPC8xx_MemCo *) clientData;
    int offs = (address >> 3) & 7;
...
static void or_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    MPC8xx_MemCo *memco = (MPC8xx_MemCo *) clientData;
    int cs = (address >> 3) & 7;
    int update = 0;
...
static uint32_t mar_read(void *clientData, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco read MAR register %08x not implemented\n", address);
    return 0;
}
static void mar_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco write MAR register %08x not implemented\n", address);
}

static uint32_t mcr_read(void *clientData, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco read MCR register %08x not implemented\n", address);
    return 0;
}
static void mcr_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco write MCR register %08x not implemented\n", address);
}
static uint32_t mamr_read(void *clientData, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco read MAMR register %08x not implemented\n", address);
    return 0;
}
static void mamr_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx MAMR write register %08x not implemented\n", address);
}
static uint32_t mbmr_read(void *clientData, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx MBMR read register %08x not implemented\n", address);
    return 0;
}
static void mbmr_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx MBMR write register %08x not implemented\n", address);
}
static uint32_t mstat_read(void *clientData, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco read MSTAT register %08x not implemented\n", address);
    return 0;
}
static void mstat_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco write MSTAT register %08x not implemented\n", address);
}
static uint32_t mptpr_read(void *clientData, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx-Memco read MPTPR register %08x not implemented\n", address);
    return 0;
}
static void mptpr_write(void *clientData, uint32_t value, uint32_t address, int rqlen)
{
    fprintf(stderr, "MPC8xx write MPTPR register %08x not implemented\n", address);
}

static void MPC8xx_MemCoMap(MPC8xx_MemCo * memco)
{
    int i;
    uint32_t addr;
...
static void MPC8xx_MemCoUnMap(MPC8xx_MemCo * memco)
{
    int i;
    uint32_t addr;
    uint32_t base = IMMR_ISB(memco->immr);
...
static uint32_t MemCo_ImmrRead(int spr, void *cd)
{
 ...
 * -----------------------------------------------------------
 */
void MemCo_ImmrWrite(uint32_t value, int spr, void *cd)
{
    MPC8xx_MemCo *memco = (MPC8xx_MemCo *) cd;
...
MPC8xx_MemCo *MPC8xx_MemController_New(PpcCpu * cpu)
{
