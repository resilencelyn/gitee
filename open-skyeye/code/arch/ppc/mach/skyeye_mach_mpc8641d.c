...
int skyeye_mach_mpc8641d_set_space(conf_object_t * obj, addr_space_t * space)
{
...
addr_space_t *skyeye_mach_mpc8641d_get_space(conf_object_t * obj)
{
    skyeye_mach_mpc8641d_device *mach = obj->obj;
...
int skyeye_mach_mpc8641d_set_core(conf_object_t * obj, conf_object_t * core)
{
    skyeye_mach_mpc8641d_device *mach = obj->obj;
...
conf_object_t *skyeye_mach_mpc8641d_get_core_by_id(conf_object_t * obj, int id)
{
    skyeye_mach_mpc8641d_device *mach = obj->obj;
...
static void mpc8641d_register_interface(conf_class_t * clss)
{
    static const skyeye_machine_intf mach_intf = {
        .set_space = skyeye_mach_mpc8641d_set_space,
        .set_core = skyeye_mach_mpc8641d_set_core,
        .get_core_by_id = skyeye_mach_mpc8641d_get_core_by_id,
        .get_space = skyeye_mach_mpc8641d_get_space,
...
static exception_t skyeye_mach_mpc8641d_set_attr(conf_object_t * obj, const char *attr_name, attr_value_t * value)
{
    return No_exp;
}

static attr_value_t *skyeye_mach_mpc8641d_get_attr(const char *attr_name, conf_object_t * obj)
{
    return NULL;
}
...
void init_skyeye_mach_mpc8641d()
{
    static skyeye_class_t class_data = {
        ...
        .get_attr = skyeye_mach_mpc8641d_get_attr,
        .set_attr = skyeye_mach_mpc8641d_set_attr
    };
