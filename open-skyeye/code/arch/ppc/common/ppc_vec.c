...
static inline uint32 UNPACK_PIXEL(uint16 clr)
{
    return (((uint32) (clr & 0x001f)) |
            ((uint32) (clr & 0x03E0) << 3) | ((uint32) (clr & 0x7c00) << 6) | (((clr) & 0x8000) ? 0xff000000 : 0));
}

static inline uint8 SATURATE_UB(e500_core_t *current_core, uint16 val)
{
    if (val & 0xff00)
    {
...
static inline uint8 SATURATE_0B(e500_core_t *current_core, uint16 val)
{
    if (val & 0xff00)
    {
        current_core->vscr |= VSCR_SAT;
...
static inline uint16 SATURATE_UH(e500_core_t *current_core, uint32 val)
{
    if (val & 0xffff0000)
    {
        current_core->vscr |= VSCR_SAT;
...
static inline uint16 SATURATE_0H(e500_core_t *current_core, uint32 val)
{
    if (val & 0xffff0000)
    {
        current_core->vscr |= VSCR_SAT;
...
static inline sint8 SATURATE_SB(e500_core_t *current_core, sint16 val)
{
    if (val > 127)
    {                                   // 0x7F
        current_core->vscr |= VSCR_SAT;
...
static inline uint8 SATURATE_USB(e500_core_t *current_core, sint16 val)
{
    if (val > 0xff)
    {
        current_core->vscr |= VSCR_SAT;
...
static inline sint16 SATURATE_SH(e500_core_t *current_core, sint32 val)
{
    if (val > 32767)
    {                                   // 0x7fff
        current_core->vscr |= VSCR_SAT;
...
static inline uint16 SATURATE_USH(e500_core_t *current_core, sint32 val)
{
    if (val > 0xffff)
    {
        current_core->vscr |= VSCR_SAT;
...
static inline sint32 SATURATE_UW(e500_core_t *current_core, sint64 val)
{
    if (val > 0xffffffffLL)
    {
        current_core->vscr |= VSCR_SAT;
...
static inline sint32 SATURATE_SW(e500_core_t *current_core, sint64 val)
{
    if (val > 2147483647LL)
    {                                   // 0x7fffffff
        current_core->vscr |= VSCR_SAT;
...
void ppc_opc_vpkuhus(e500_core_t *current_core)
{
    ...
    VECT_B(r, 0) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 0));
    VECT_B(r, 1) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 1));
    VECT_B(r, 2) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 2));
    VECT_B(r, 3) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 3));
    VECT_B(r, 4) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 4));
    VECT_B(r, 5) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 5));
    VECT_B(r, 6) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 6));
    VECT_B(r, 7) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrA], 7));

    VECT_B(r, 8) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 0));
    VECT_B(r, 9) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 1));
    VECT_B(r, 10) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 2));
    VECT_B(r, 11) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 3));
    VECT_B(r, 12) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 4));
    VECT_B(r, 13) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 5));
    VECT_B(r, 14) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 6));
    VECT_B(r, 15) = SATURATE_UB(current_core, VECT_H(current_core->vr[vrB], 7));
...
void ppc_opc_vpkshss(e500_core_t *current_core)
{
    ...
    VECT_B(r, 0) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 0));
    VECT_B(r, 1) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 1));
    VECT_B(r, 2) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 2));
    VECT_B(r, 3) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 3));
    VECT_B(r, 4) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 4));
    VECT_B(r, 5) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 5));
    VECT_B(r, 6) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 6));
    VECT_B(r, 7) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrA], 7));

    VECT_B(r, 8) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 0));
    VECT_B(r, 9) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 1));
    VECT_B(r, 10) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 2));
    VECT_B(r, 11) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 3));
    VECT_B(r, 12) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 4));
    VECT_B(r, 13) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 5));
    VECT_B(r, 14) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 6));
    VECT_B(r, 15) = SATURATE_SB(current_core, VECT_H(current_core->vr[vrB], 7));
...
void ppc_opc_vpkuwus(e500_core_t *current_core)
{
    ...
    VECT_H(r, 0) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrA], 0));
    VECT_H(r, 1) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrA], 1));
    VECT_H(r, 2) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrA], 2));
    VECT_H(r, 3) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrA], 3));

    VECT_H(r, 4) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrB], 0));
    VECT_H(r, 5) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrB], 1));
    VECT_H(r, 6) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrB], 2));
    VECT_H(r, 7) = SATURATE_UH(current_core, VECT_W(current_core->vr[vrB], 3));
...
void ppc_opc_vpkswss(e500_core_t *current_core)
{
    ...
    VECT_H(r, 0) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrA], 0));
    VECT_H(r, 1) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrA], 1));
    VECT_H(r, 2) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrA], 2));
    VECT_H(r, 3) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrA], 3));

    VECT_H(r, 4) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrB], 0));
    VECT_H(r, 5) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrB], 1));
    VECT_H(r, 6) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrB], 2));
    VECT_H(r, 7) = SATURATE_SH(current_core, VECT_W(current_core->vr[vrB], 3));
...
void ppc_opc_vpkshus(e500_core_t *current_core)
{
    ...
    VECT_B(r, 0) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 0));
    VECT_B(r, 1) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 1));
    VECT_B(r, 2) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 2));
    VECT_B(r, 3) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 3));
    VECT_B(r, 4) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 4));
    VECT_B(r, 5) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 5));
    VECT_B(r, 6) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 6));
    VECT_B(r, 7) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrA], 7));

    VECT_B(r, 8) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 0));
    VECT_B(r, 9) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 1));
    VECT_B(r, 10) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 2));
    VECT_B(r, 11) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 3));
    VECT_B(r, 12) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 4));
    VECT_B(r, 13) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 5));
    VECT_B(r, 14) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 6));
    VECT_B(r, 15) = SATURATE_USB(current_core, VECT_H(current_core->vr[vrB], 7));
...
void ppc_opc_vpkswus(e500_core_t *current_core)
{
    ...
    VECT_H(r, 0) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrA], 0));
    VECT_H(r, 1) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrA], 1));
    VECT_H(r, 2) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrA], 2));
    VECT_H(r, 3) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrA], 3));

    VECT_H(r, 4) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrB], 0));
    VECT_H(r, 5) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrB], 1));
    VECT_H(r, 6) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrB], 2));
    VECT_H(r, 7) = SATURATE_USH(current_core, VECT_W(current_core->vr[vrB], 3));
...
void ppc_opc_vaddfp(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {                                   //FIXME: This might not comply with Java FP
...
void ppc_opc_vaddubs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        current_core->vr[vrD].b[i] = SATURATE_UB(current_core, res);
    }
}
...
void ppc_opc_vaddsbs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        current_core->vr[vrD].b[i] = SATURATE_SB(current_core, res);
    }
}
...
void ppc_opc_vadduhs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        current_core->vr[vrD].h[i] = SATURATE_UH(current_core, res);
    }
}
...
void ppc_opc_vaddshs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        current_core->vr[vrD].h[i] = SATURATE_SH(current_core, res);
    }
}
...
void ppc_opc_vsububs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        current_core->vr[vrD].b[i] = SATURATE_0B(current_core, res);
    }
}
...
void ppc_opc_vsubsbs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        current_core->vr[vrD].sb[i] = SATURATE_SB(current_core, res);
    }
}
...
void ppc_opc_vsubuhs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        current_core->vr[vrD].h[i] = SATURATE_0H(current_core, res);
    }
}
...
void ppc_opc_vsubshs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        current_core->vr[vrD].sh[i] = SATURATE_SH(current_core, res);
    }
}
...
void ppc_opc_vmuleub(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        res = (uint16) current_core->vr[vrA].b[VECT_EVEN(i)] * (uint16) current_core->vr[vrB].b[VECT_EVEN(i)];
...
void ppc_opc_vmulesb(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        res = (sint16) current_core->vr[vrA].sb[VECT_EVEN(i)] * (sint16) current_core->vr[vrB].sb[VECT_EVEN(i)];
...
void ppc_opc_vmuleuh(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        res = (uint32) current_core->vr[vrA].h[VECT_EVEN(i)] * (uint32) current_core->vr[vrB].h[VECT_EVEN(i)];
...
void ppc_opc_vmulesh(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        res = (sint32) current_core->vr[vrA].sh[VECT_EVEN(i)] * (sint32) current_core->vr[vrB].sh[VECT_EVEN(i)];
...
void ppc_opc_vmuloub(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        res = (uint16) current_core->vr[vrA].b[VECT_ODD(i)] * (uint16) current_core->vr[vrB].b[VECT_ODD(i)];
...
void ppc_opc_vmulosb(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        res = (sint16) current_core->vr[vrA].sb[VECT_ODD(i)] * (sint16) current_core->vr[vrB].sb[VECT_ODD(i)];
...
void ppc_opc_vmulouh(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        res = (uint32) current_core->vr[vrA].h[VECT_ODD(i)] * (uint32) current_core->vr[vrB].h[VECT_ODD(i)];
...
void ppc_opc_vmulosh(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        res = (sint32) current_core->vr[vrA].sh[VECT_ODD(i)] * (sint32) current_core->vr[vrB].sh[VECT_ODD(i)];
...
void ppc_opc_vmhaddshs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        current_core->vr[vrD].sh[i] = SATURATE_SH(current_core, prod);
    }
}
...
void ppc_opc_vmsumubm(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        temp += (uint16) current_core->vr[vrA].b[i << 2] * (uint16) current_core->vr[vrB].b[i << 2];

        temp += (uint16) current_core->vr[vrA].b[(i << 2) + 1] * (uint16) current_core->vr[vrB].b[(i << 2) + 1];

        temp += (uint16) current_core->vr[vrA].b[(i << 2) + 2] * (uint16) current_core->vr[vrB].b[(i << 2) + 2];

        temp += (uint16) current_core->vr[vrA].b[(i << 2) + 3] * (uint16) current_core->vr[vrB].b[(i << 2) + 3];
...
void ppc_opc_vmsumuhm(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        temp += (uint32) current_core->vr[vrA].h[i << 1] * (uint32) current_core->vr[vrB].h[i << 1];
        temp += (uint32) current_core->vr[vrA].h[(i << 1) + 1] * (uint32) current_core->vr[vrB].h[(i << 1) + 1];
...
void ppc_opc_vmsummbm(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        temp += (sint16) current_core->vr[vrA].sb[i << 2] * (uint16) current_core->vr[vrB].b[i << 2];
        temp += (sint16) current_core->vr[vrA].sb[(i << 2) + 1] * (uint16) current_core->vr[vrB].b[(i << 2) + 1];
        temp += (sint16) current_core->vr[vrA].sb[(i << 2) + 2] * (uint16) current_core->vr[vrB].b[(i << 2) + 2];
        temp += (sint16) current_core->vr[vrA].sb[(i << 2) + 3] * (uint16) current_core->vr[vrB].b[(i << 2) + 3];
...
void ppc_opc_vmsumshm(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        temp += (sint32) current_core->vr[vrA].sh[i << 1] * (sint32) current_core->vr[vrB].sh[i << 1];
        temp += (sint32) current_core->vr[vrA].sh[(i << 1) + 1] * (sint32) current_core->vr[vrB].sh[(i << 1) + 1];
...
void ppc_opc_vmsumuhs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        current_core->vr[vrD].w[i] = SATURATE_UW(current_core, temp);
    }
}
...
void ppc_opc_vmsumshs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        current_core->vr[vrD].sw[i] = SATURATE_SW(current_core, temp);
    }
}
...
void ppc_opc_vsum4ubs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        current_core->vr[vrD].w[i] = SATURATE_UW(current_core, res);
    }
}
...
void ppc_opc_vsum4sbs(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        current_core->vr[vrD].sw[i] = SATURATE_SW(current_core, res);
    }
}
...
void ppc_opc_vsum2sws(e500_core_t *current_core)
{
    ...
    current_core->vr[vrD].w[VECT_ODD(0)] = SATURATE_SW(current_core, res);
    ...
    current_core->vr[vrD].w[VECT_ODD(1)] = SATURATE_SW(current_core, res);
...
void ppc_opc_vsumsws(e500_core_t *current_core)
{
    ...
    VECT_W(current_core->vr[vrD], 3) = SATURATE_SW(current_core, res);
    VECT_W(current_core->vr[vrD], 2) = 0;
...
void ppc_opc_vavgub(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 16; i++)
    {
        res = (uint16) current_core->vr[vrA].b[i] + (uint16) current_core->vr[vrB].b[i] + 1;
...
void ppc_opc_vavguh(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        res = (uint32) current_core->vr[vrA].h[i] + (uint32) current_core->vr[vrB].h[i] + 1;
...
void ppc_opc_vavguw(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        res = (uint64) current_core->vr[vrA].w[i] + (uint64) current_core->vr[vrB].w[i] + 1;
...
void ppc_opc_vavgsb(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 16; i++)
    {
        res = (sint16) current_core->vr[vrA].sb[i] + (sint16) current_core->vr[vrB].sb[i] + 1;
...
void ppc_opc_vavgsh(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 8; i++)
    {
        res = (sint32) current_core->vr[vrA].sh[i] + (sint32) current_core->vr[vrB].sh[i] + 1;
...
void ppc_opc_vavgsw(e500_core_t *current_core)
{
    ...
    for (i = 0; i < 4; i++)
    {
        res = (sint64) current_core->vr[vrA].sw[i] + (sint64) current_core->vr[vrB].sw[i] + 1;
