...
typedef enum
{
    ...
    t_t2_decoded                        /* Thumb2 instr (already processed).  */
}
tdstate;
...
extern tdstate ARMul_Thumb2Decode(ARMul_State *, ARMword, ARMword, ARMword *);
extern ARMword ARMul_GetReg(ARMul_State *, unsigned, unsigned);
extern void ARMul_SetReg(ARMul_State *, unsigned, unsigned, ARMword);
extern void ARMul_ScheduleEvent(ARMul_State *, unsigned int, unsigned (*)(ARMul_State *));
