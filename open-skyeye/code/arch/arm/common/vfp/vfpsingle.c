...
u32 vfp_single_normaliseround(ARMul_State * state, int sd, struct vfp_single *vs, u32 fpscr, u32 exceptions,
                              const char *func)
{
 ...
 */
static u32 vfp_propagate_nan(struct vfp_single *vsd, struct vfp_single *vsn, struct vfp_single *vsm, u32 fpscr)
{
...
static u32 vfp_single_fadd_nonnumber(struct vfp_single *vsd, struct vfp_single *vsn, struct vfp_single *vsm, u32 fpscr)
{
...
static u32 vfp_single_add(struct vfp_single *vsd, struct vfp_single *vsn, struct vfp_single *vsm, u32 fpscr)
{
    u32 exp_diff, m_sig;
...
static u32 vfp_single_multiply(struct vfp_single *vsd, struct vfp_single *vsn, struct vfp_single *vsm, u32 fpscr)
{
    vfp_single_dump("VSN", vsn);
    vfp_single_dump("VSM", vsm);
...
static u32 vfp_single_multiply_accumulate(ARMul_State * state, int sd, int sn, s32 m, u32 fpscr, u32 negate, char *func)
{
 ...
 * sd = sn * sm
 */
u32 vfp_single_fmul(ARMul_State * state, int sd, int sn, s32 m, u32 fpscr)
{
 ...
 * sd = sn + sm
 */
u32 vfp_single_fadd(ARMul_State * state, int sd, int sn, s32 m, u32 fpscr)
{
    struct vfp_single vsd, vsn, vsm;
    u32 exceptions;
    s32 n = vfp_get_float(state, sn);
 ...
 * sd = sn - sm
 */
u32 vfp_single_fsub(ARMul_State * state, int sd, int sn, s32 m, u32 fpscr)
{
    pr_debug("In %sVFP: s%u = %08x\n", __FUNCTION__, sn, sd);
    /*
 ...
 * sd = sn / sm
 */
u32 vfp_single_fdiv(ARMul_State * state, int sd, int sn, s32 m, u32 fpscr)
{
    struct vfp_single vsd, vsn, vsm;
    u32 exceptions = 0;
    s32 n = vfp_get_float(state, sn);
...
u32 vfp_single_cpdo(ARMul_State * state, u32 inst, u32 fpscr)
{
    ...
    pr_debug("VFP: vecstride=%u veclen=%u\n", vecstride, (veclen >> FPSCR_LENGTH_BIT) + 1);
