...
static unsigned DSPInit(ARMul_State * state)
{
            ...
            switch (opcode2)
            {
                case 0:                /* cfmuls */
                    printfdbg("cfmuls mvf%d = mvf%d = %f\n",
                              DEST_REG, SRC1_REG, DSPregs[SRC1_REG].upper.f * DSPregs[SRC2_REG].upper.f);
                ...
                case 1:                /* cfmuld */
                    printfdbg("cfmuld mvd%d = mvd%d = %g\n",
                              DEST_REG, SRC1_REG, mv_getRegDouble(SRC1_REG) * mv_getRegDouble(SRC2_REG));
            ...
            switch (opcode2)
            {
                case 0:                /* cfabss */
                    DSPregs[DEST_REG].upper.f =
                        (DSPregs[SRC1_REG].upper.f < 0.0F ? -DSPregs[SRC1_REG].upper.f : DSPregs[SRC1_REG].upper.f);
                ...
                case 1:                /* cfabsd */
                    mv_setRegDouble(DEST_REG,
                                    (mv_getRegDouble(SRC1_REG) < 0.0 ?
                                     -mv_getRegDouble(SRC1_REG) : mv_getRegDouble(SRC1_REG)));
                ...
                case 5:                /* cfaddd */
                    ...
                    printfdbg("cfaddd: mvd%d = mvd%d + mvd%d = %g\n",
                              DEST_REG, SRC1_REG, SRC2_REG, mv_getRegDouble(DEST_REG));
                    break;
            ...
            switch (opcode2)
            {
                case 0:                /* cfabs32 */
                    DSPregs[DEST_REG].lower.i =
                        (DSPregs[SRC1_REG].lower.i < 0 ? -DSPregs[SRC1_REG].lower.i : DSPregs[SRC1_REG].lower.i);
                ...
                case 1:                /* cfabs64 */
                    mv_setReg64int(DEST_REG,
                                   (mv_getReg64int(SRC1_REG) < 0
                                    ? -mv_getReg64int(SRC1_REG) : mv_getReg64int(SRC1_REG)));
