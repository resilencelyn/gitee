...
fault_t translate(ARMul_State * state, ARMword virt_addr, tlb_s * tlb_t, tlb_entry_t ** tlb)
{
...
void mmu_tlb_invalidate_entry(ARMul_State * state, tlb_s * tlb_t, ARMword addr)
{
    tlb_entry_t *tlb;
...
tlb_entry_t *mmu_tlb_search(ARMul_State * state, tlb_s * tlb_t, ARMword virt_addr)
{
    int entry;
