...
unsigned xscale_cp13_ldc(ARMul_State * state, unsigned type, ARMword instr, ARMword data)
{
...
mmu_ops_t xscale_mmu_ops =
{
    xscale_cp15_init,
        ...
        xscale_mmu_read_word, xscale_mmu_write_word, xscale_mmu_load_instr, xscale_mmu_mcr, xscale_mmu_mrc,
        //teawater add for arm2x86 2005.06.24-------------------------------------------
        xscale_mmu_v2p_dbct,
        //AJ2D--------------------------------------------------------------------------
};
