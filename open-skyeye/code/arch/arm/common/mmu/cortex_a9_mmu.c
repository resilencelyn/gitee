...
fault_t cortex_a9_mmu_write(ARMul_State * state, ARMword va, ARMword data, ARMword datatype);
fault_t cortex_a9_mmu_read(ARMul_State * state, ARMword va, ARMword * data, ARMword datatype);

int cortex_a9_mmu_init(ARMul_State * state)
{
...
void cortex_a9_mmu_exit(ARMul_State * state)
{
}

fault_t cortex_a9_mmu_load_instr(ARMul_State * state, ARMword va, ARMword * instr)
{
    fault_t fault;
    int c;                              /* cache bit */
...
fault_t cortex_a9_mmu_read_byte(ARMul_State * state, ARMword virt_addr, ARMword * data)
{
    /* ARMword temp,offset; */
    fault_t fault;
...
fault_t cortex_a9_mmu_read_halfword(ARMul_State * state, ARMword virt_addr, ARMword * data)
{
    /* ARMword temp,offset; */
    fault_t fault;
...
fault_t cortex_a9_mmu_read_word(ARMul_State * state, ARMword virt_addr, ARMword * data)
{
...
fault_t cortex_a9_mmu_write_byte(ARMul_State * state, ARMword virt_addr, ARMword data)
{
    return cortex_a9_mmu_write(state, virt_addr, data, ARM_BYTE_TYPE);
}

fault_t cortex_a9_mmu_write_halfword(ARMul_State * state, ARMword virt_addr, ARMword data)
{
    return cortex_a9_mmu_write(state, virt_addr, data, ARM_HALFWORD_TYPE);
}

fault_t cortex_a9_mmu_write_word(ARMul_State * state, ARMword virt_addr, ARMword data)
{
...
ARMword cortex_a9_mmu_mrc(ARMul_State * state, ARMword instr, ARMword * value)
{
...
static ARMword cortex_a9_mmu_mcr(ARMul_State * state, ARMword instr, ARMword value)
{
    mmu_regnum_t creg = BITS(16, 19) & 0xf;
...
static int cortex_a9_mmu_v2p_dbct(ARMul_State * state, ARMword virt_addr, ARMword * phys_addr)
{
    fault_t fault;
    int ap, sop;
