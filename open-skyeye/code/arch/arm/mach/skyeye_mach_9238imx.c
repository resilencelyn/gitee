...
static ARMword imx_io_read_word(void *state, ARMword addr)
{
    ARMword data;
...
static ARMword imx_io_read_byte(void *state, ARMword addr)
{
    return imx_io_read_word(state, addr);

}

ARMword imx_io_read_halfword(void *state, ARMword addr)
{
    return imx_io_read_word(state, addr);
}

void imx_io_write_word(void *state, ARMword addr, ARMword data)
{
    /*
...
void imx_io_write_byte(void *state, ARMword addr, ARMword data)
{
...
void imx_io_write_halfword(void *state, ARMword addr, ARMword data)
{
    imx_io_write_word(state, addr, data);
    //SKYEYE_OUTREGS(stderr);
    //exit(-1);
}
static void imx_io_reset(void *curr_state)
{
}

void imx_mach_init(void *arch_instance, machine_config_t * this_mach)
{
