...
void bx_init_options()
{
  ...
  *pci_deps_ptr = NULL;
  ...
  // ne2k2 options
  menu = new bx_list_c(network, "ne2k2", "NE2002", 7);
  menu->set_options(menu->SHOW_PARENT);
  menu->set_enabled(BX_SUPPORT_NE2K);
  enabled = new bx_param_bool_c(menu,
    "enabled",
  ...
  macaddr = new bx_param_string_c(menu,
    "macaddr",
    "MAC Address",
    "MAC address of the NE2K2 device. Don't use an address of a machine on your net.",
    "", 6);
  macaddr->set_options(macaddr->RAW_BYTES);
  macaddr->set_initial_val("\xfe\xfd\xde\xad\xbe\xef");
  macaddr->set_separator(':');
  ethmod = new bx_param_enum_c(menu,
    ...
    0);
  ethmod->set_by_name("null");
  ethmod->set_ask_format("Choose ethernet module for the NE2K2 [%s] ");
  ethdev = new bx_param_string_c(menu,
    "ethdev",
    "Ethernet device",
    "Device used for the connection to the real net. This is only valid if an ethernet module other than 'null' is used.",
...
#if BX_SUPPORT_KIO
  new bx_param_bool_c(menu, "kio", "Set 'KIO'", "", 1);
#endif

#if BX_SUPPORT_BU_61580
  new bx_param_bool_c(menu, "bu_61580", "Set 'BU_61580'", "", 1);
#endif
#if BX_SUPPORT_PCI
