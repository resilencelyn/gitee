...
public:
  ...
  bx_ne2k_t s;
  Bit32u (*read_ram)(void* this_ptr, Bit32u address, unsigned io_len);
...
private:
  ...
  static Bit32u chipram_read(void *this_ptr, Bit32u address, unsigned io_len); /* for fault injection */
