...
class BOCHSAPI bx_ne2k2_stub_c : public bx_devmodel_c {
public:
  virtual void print_info(FILE *file, int page, int reg, int nodups) {}
};
...
#if BX_SUPPORT_KIO
class BOCHSAPI bx_kio_stub_c : public bx_devmodel_c {
public:
  virtual void mem_write(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(kio, mem_write);
  }
  virtual void mem_read(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(kio, mem_read);
  }
};
#endif
...
public:
 ...
 ~bx_devices_c();
  ...
  bx_ne2k2_stub_c    *pluginNE2k2Device;
