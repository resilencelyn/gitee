...
#endif
#if BX_SUPPORT_KIO
      else if (!strcmp(plugname, BX_PLUGIN_KIO)) {
        PLUG_load_plugin(kio, PLUGTYPE_OPTIONAL);
      }
#endif

#if BX_SUPPORT_BU_61580
      else if (!strcmp(plugname, BX_PLUGIN_BU_61580)) {
...
#else
    BX_ERROR(("Bochs is not compiled with NE2K2 support"));
#endif
  }
