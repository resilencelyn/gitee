...
static conf_object_t *new_c2812_core(char *obj_name)
{
...
static void free_c2812_core(conf_object_t * dev)
{
...
static exception_t reset_c2812_core(conf_object_t * obj, const char *parameter)
{
...
static uint32 c2812_get_regnum(conf_object_t * obj)
{
    return C2812_REGNUM;
}

static uint32 c2812_get_regvalue_by_id(conf_object_t * obj, uint32 id)
{
    c28_core_t *core = (c28_core_t *) obj->obj;
...
static exception_t c2812_set_regvalue_by_id(conf_object_t * obj, uint32 value, uint32 id)
{
    c28_core_t *core = (c28_core_t *) obj->obj;
...
static uint32 c2812_get_regid_by_name(conf_object_t * opaque, char *name)
{
    int i;

    for (i = 0; i < C2812_REGNUM; i++)
    {
        if (strcmp(name, c2812_regstr[i]) == 0)
            return i;
    }
    return 0;
}

static const char *c2812_get_regname_by_id(conf_object_t * obj, uint32 id)
{
    return c2812_regstr[id];
}
...
void c2812_register_attribute(conf_class_t * clss)
{
    SKY_register_attribute(clss, "freq_hz", get_attr_freq_hz, NULL, set_attr_freq_hz, NULL, SKY_Attr_Optional,
                           "uinteger", "c2812 cpu freq_hz");
}

void init_c2812_core()
{
    static skyeye_class_t class_data = {
        .class_name = "c2812_core",
        .class_desc = "TI c2812 processor core",
        .new_instance = new_c2812_core,
        .free_instance = free_c2812_core,
        .reset_instance = reset_c2812_core,
        .get_attr = NULL,
        .set_attr = NULL
    };
    ...
    static const skyeye_reg_intf reg = {
        .get_regvalue_by_id = c2812_get_regvalue_by_id,
        .get_regname_by_id = c2812_get_regname_by_id,
        .set_regvalue_by_id = c2812_set_regvalue_by_id,
        .get_regid_by_name = c2812_get_regid_by_name,
        .get_regnum = c2812_get_regnum,
    };
