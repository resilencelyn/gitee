...
class BOCHSAPI bx_bu_61580_stub_c : public bx_devmodel_c {
public:
  virtual void mem_write(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(bu_61580, mem_write);
  }
  virtual void mem_read(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(bu_61580, mem_read);
  }
};
#endif

#if BX_SUPPORT_SJA1000
class BOCHSAPI bx_sja1000_stub_c : public bx_devmodel_c {
public:
  virtual void mem_write(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(sja1000, mem_write);
  }
  virtual void mem_read(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(sja1000, mem_read);
  }
};
#endif

#if BX_SUPPORT_GPIO
class BOCHSAPI bx_gpio_stub_c : public bx_devmodel_c {
public:
  virtual void mem_write(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(gpio, mem_write);
  }
  virtual void mem_read(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(gpio, mem_read);
  }
};
#endif

#if BX_SUPPORT_AD
class BOCHSAPI bx_ad_stub_c : public bx_devmodel_c {
public:
  virtual void mem_write(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(ad, mem_write);
  }
  virtual void mem_read(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(ad, mem_read);
  }
};
#endif

#if BX_SUPPORT_RS422
class BOCHSAPI bx_rs422_stub_c : public bx_devmodel_c {
public:
  virtual void mem_write(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(rs422, mem_write);
  }
  virtual void mem_read(BX_CPU_C *cpu, bx_phy_address addr, unsigned len, void *data) {
    STUBFUNC(rs422, mem_read);
  }
};
#endif
...
#if BX_SUPPORT_BU_61580
	bx_bu_61580_stub_c *pluginBu_61580;
#endif

#if BX_SUPPORT_SJA1000
	bx_sja1000_stub_c *pluginsja1000;
#endif

#if BX_SUPPORT_GPIO
	bx_gpio_stub_c *plugingpio;
#endif

#if BX_SUPPORT_AD
	bx_ad_stub_c *pluginad;
#endif

#if BX_SUPPORT_RS422
	bx_rs422_stub_c *pluginrs422;
#endif
