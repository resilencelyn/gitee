...
void bx_init_options()
{
 ...
 // config interface option, set in bochsrc or command line
  ...
  new bx_param_bool_c(menu, "sja1000", "Set 'sja1000'", "", 1);
#endif

 
#if BX_SUPPORT_GPIO
  new bx_param_bool_c(menu, "gpio", "Set 'gpio'", "", 1);
#endif

#if BX_SUPPORT_AD
  new bx_param_bool_c(menu, "ad", "Set 'ad'", "", 1);
#endif

#if BX_SUPPORT_RS422
  new bx_param_bool_c(menu, "rs422", "Set 'rs422'", "", 1);
#endif
...
char *bx_find_bochsrc()
{
  ...
  while (!found) {
    rcfile[0] = 0;
    switch (retry++) {
    case 0: strcpy (rcfile, ".skyeyesrc"); break;
    case 1: strcpy (rcfile, "skyeyesrc"); break;
    case 2: strcpy (rcfile, "skyeyesrc.txt"); break;
#ifdef WIN32
    case 3: strcpy (rcfile, "skyeyesrc.bxrc"); break;
#elif !BX_WITH_MACOS
