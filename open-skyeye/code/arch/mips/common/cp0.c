            ...
            case Count:
                {
                    ...
                    mstate->cp0[Count] = x;
                    mstate->now =
                        mstate->now + (mstate->cp0[Compare] -
                                       (mstate->cp0[Count] + ((mstate->now - mstate->count_seed) / 2))) * 2;
                    break;
                }
            case EntryHi:
                {
                    ...
                    case Count:
                        {
                            ...
                            curVPE->cp0[Count] = x;
                            curVPE->now =
                                curVPE->now + (curVPE->cp0[Compare] -
                                               (curVPE->cp0[Count] + ((curVPE->now - curVPE->count_seed) / 2))) * 2;
                            break;
                        }
                    case EntryHi:
                ...
                case ERET:
                    {
                        ...
                        mstate->pc = clear_bit(mstate->cp0[EPC], 0);
                        mstate->isa_mode = bit(mstate->cp0[EPC], 0);
