 ...
 * =====================================================================================
 */
static int sparc_store_register(conf_object_t * obj, int rn, unsigned char *memory)
{
#if 0
    uint32 val;
 ...
 * =====================================================================================
 */
static int sparc_fetch_register(conf_object_t * obj, int rn, unsigned char *memory)
{
#if 0
    uint32 val;
...
void init_sparc_register_defs(void)
{
    ...
    sparc_reg_defs.byte_width = EIGHT_BITS_PER_BYTE;
