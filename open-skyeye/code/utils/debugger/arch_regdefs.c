...
register_defs_t *register_types[9];
...
extern void init_ti_c28x_register_defs();
extern void init_x86_register_defs();
...
int init_register_type()
{
    ...
    init_ti_c28x_register_defs();

    /* register x86_arch */
    init_x86_register_defs();
