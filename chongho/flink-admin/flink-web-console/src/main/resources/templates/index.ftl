					...
					<div class="col-xs-12" style="padding-left: 0px;padding-right: 0px;">
						...
						<div class="tab-content" style="border: none">
							<div role="tabpanel" class="tab-pane active" id="Index" >
								flink自建集群_Version:1.13.3
								<#list flinkList as flink>
									 <div id="piechart-placeholder" style="margin-top: 30px;">
										 <div class="panel panel-default" style="width: 40%;float: left;margin-left: 5%">
											 <div class="panel-heading"><h4><a href="${flink.url}" target="_blank">${flink.name}</a></h4></div>
											 <table class="table">
												 <tr>
													 <td style="text-align:center;vertical-align:middle;" colspan="6"><h6>Task Slots</h6></td>
												 </tr>
												 <tr>
													 <td colspan="2">Available Task Slots</td>
													 <td style="font-size: large;color:#00BE67;" colspan="4">${(flink.slotsavailable)!}</td>
												 </tr>
												 <tr>
													<td colspan="2">Total Task Slots</td>
													<td colspan="4">${(flink.slotstotal)!}</td>
												 </tr>
												 <tr>
													 <td colspan="2">Task Managers</td>
													 <td colspan="4">${(flink.taskmanagers)!}</td>
												 </tr>
												 <tr>
													 <td style="text-align:center;vertical-align:middle;" colspan="6"><h6>Jobs</h6></td>
												 </tr>
												 <tr>
													 <td rowspan="2" style="text-align:center;vertical-align:middle;">Running Jobs</td>
													 <td rowspan="2" style="text-align:center;vertical-align:middle;border-right:1px solid #ddd;">
														 <span style="font-size: large;color:#00BE67;">${(flink.jobsrunning)!}</span>
													 </td>
													 <td>job</td>
													 <td  style="font-size: large;color:#00BE67;" colspan="3">${(flink.jobRuningCount)!}</td>
												 </tr>
												 <tr>
													 <td>cdcjob</td>
													 <td  style="font-size: large;color:#00BE67;" colspan="3">${(flink.cdcjobRuningCount)!}</td>
												 </tr>
